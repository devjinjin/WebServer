    ...
    public partial class t1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 3, 31, 11, 2, 28, 5, DateTimeKind.Local).AddTicks(1700), false, "상품", 0, "/product" },
                    { 2, new DateTime(2021, 3, 31, 11, 2, 28, 7, DateTimeKind.Local).AddTicks(862), false, "PLACE", 1, "/place" },
                    { 3, new DateTime(2021, 3, 31, 11, 2, 28, 7, DateTimeKind.Local).AddTicks(925), false, "게시판", 2, "/board" },
                    { 4, new DateTime(2021, 3, 31, 11, 2, 28, 7, DateTimeKind.Local).AddTicks(928), false, "공지사항", 3, "/notice" }
                });
